...
namespace MTTKDotNetCore.Shared
{
    public class AdoDotNetService
    {
        ...
        public DataTable Query(string query, params SqlParameterModel[] sqlParameters) //SqlParameterModel[] sqlParameters = null
        {
        ...
        public int Execute(string query, params SqlParameterModel[] sqlParameters) //SqlParameterModel[] sqlParameters = null
        {
            SqlConnection connection = new SqlConnection(_connectionString);
            connection.Open();
        ...
        public int ExecuteNonQuery(string query, params SqlParameterModel[] sqlParameters) //SqlParameterModel[] sqlParameters = null
        {
            SqlConnection connection = new SqlConnection(_connectionString);
            connection.Open();
